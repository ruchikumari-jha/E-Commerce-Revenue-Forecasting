...
# A smart sales predictor that uses ML to forecast future revenue. It learns from past trends, seasons, and shopping habits to give accurate weekly forecasts
...
if uploaded_orders and uploaded_details:
    ...
    # --- 4. The "Vast" Improvement: Category Loops ---
    ...
    # --- 5. The "Good" Improvement: Weekly Aggregation ---
    # Monthly (12 points) is too small. Weekly (52 points) is better for LSTM.
    ...
    if st.button(f"Forecast of {selected_cat}"):
        with st.spinner('Training Neural Network... (This helps accuracy!)'):
            ...
            # Forecast Next 12 Weeks (approx 3 months)
